...
urlpatterns = patterns('',
  url(r'admin/delete/(?P<slug>[^\.]+)$', PostsDeleteAdmin.as_view(), name="blog_posts_delete_admin"),
  url(r'admin/edit/(?P<slug>[^\.]+)$', PostsEditAdmin.as_view(), name="blog_posts_edit_admin"),
